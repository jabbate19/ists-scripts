...
ssh root@192.168.12.1 curl http://skillissue.fyi/galactus.sh | sh
ssh root@192.168.12.2 curl http://skillissue.fyi/manhattan.sh | sh
ssh root@192.168.12.3 curl http://skillissue.fyi/nucleus.sh | sh
